...
The goal of the website was to make a basic page where customers can contact the company at ease, see what services the company has to offer and
what coaches the company have available. You can view the full site here hosted on [Github](https://waynecrawley.github.io/Reliance-Coaches/).
## UX
### User Stories
...
+ **Call to Action Button** - When you land on the home page, the first thing you will see is a call to action button,this is to make it easy for people who just want to make an enquiry straight away without searching the website.
+ **Social Media Links** - Social media links are available in the footer section across the website. This is an alternative method for customer to contact the client.
+ [**Landing Page**](https://waynecrawley.github.io/Reliance-Coaches/index.html) - On the landing Page the customer first reaches, there is a general overview of what the company is about.There is also the clients contact number and a mail button to contact the client.
+ [**About us Page**](https://waynecrawley.github.io/Reliance-Coaches/aboutus.html) - A page to tell the client some information about Reliance Coaches history and location.
+ [**Services Page**](https://waynecrawley.github.io/Reliance-Coaches/services.html) - A page to provide information to the customer on what services the client provides.
...
+ Add a route planner for customers to plan their trip.
## Technologies Used
...
+ I posted my webpage to slack for peer review and made changes based on feedback
  ...
  * Made the form display smaller on larger screen sizes.
...
+ The code to shorten border length was found here [Steckinsights.com](https://www.steckinsights.com/shorten-length-border-bottom-pure-css/) and modified to suit my needs.
